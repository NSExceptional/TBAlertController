...
TBAlertController tries to be as much of a drop-in replacement for the iOS 7 classes as possible, and adds a simpler interface for iOS 8. TBAlertController objects will respond to `show`, `showInView:`, and implements it's own `showFromViewController:animated:completion:` (as well as a simpler `showFromViewController:`).
